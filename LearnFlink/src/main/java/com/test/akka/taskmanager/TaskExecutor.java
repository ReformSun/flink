 ...
 */
package com.test.akka.taskmanager;
...
public class TaskExecutor extends RpcEndpoint implements TaskExecutorGateway {
	...
	public void disconnectJobManager(JobID jobId, Exception cause) {
		System.out.println("断开任务管理器：disconnectJobManager");
	...
	public void disconnectResourceManager(Exception cause) {
		System.out.println("断开资源管理器：disconnectResourceManager");
	...
	private ResourceManagerAddress createResourceManagerAddress(@Nullable String newLeaderAddress, @Nullable ResourceManagerId newResourceManagerId) {
		System.out.println("创建资源管理器地址：createResourceManagerAddress");
	...
	private void reconnectToResourceManager(Exception cause) {
		System.out.println("重新连接到资源管理器");
		closeResourceManagerConnection(cause);
		tryConnectToResourceManager();
	}

	private void tryConnectToResourceManager() {
		System.out.println("试图连接资源管理器:tryConnectToResourceManager");
	...
	private void connectToResourceManager() {
		System.out.println("连接资源管理器：connectToResourceManager");
	...
	private void closeJobManagerConnection(JobID jobId, Exception cause) {
		System.out.println("关闭任务管理器：closeJobManagerConnection");
		if (log.isDebugEnabled()) {
	...
	private void disassociateFromJobManager(JobManagerConnection jobManagerConnection, Exception cause) throws IOException {
		...
		System.out.println("切断与任务管理器的连接");
	...
	private final class JobLeaderListenerImpl implements JobLeaderListener {
		...
		public void jobManagerGainedLeadership(
			...
			System.out.println("得到任务管理器的主节点");
			runAsync(
				() ->
