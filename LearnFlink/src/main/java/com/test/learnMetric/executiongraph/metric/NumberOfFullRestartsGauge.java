...
package com.test.learnMetric.executiongraph.metric;
...
public class NumberOfFullRestartsGauge implements Gauge<Long> {
	...
	private final ExecutionGraphTest eg;

	public NumberOfFullRestartsGauge(ExecutionGraphTest executionGraph) {
